...
public class RedFarTele extends LinearOpMode {
    ...
    private static final Pose2D blueAutonoumsEnd =
            new Pose2D(DistanceUnit.INCH, 23, -35, AngleUnit.DEGREES, 0);
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            distance =
                    LocalizerClass.redGetDistance(new Pose2d(targetX, targetY, Math.toRadians(0)));

            wantedAngle = LocalizerClass.redWantedTurretHeading(new Pose2d(
                    targetX,
                    targetY,
                    Math.toRadians(0)
            ));

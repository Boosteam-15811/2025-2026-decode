...
public class ShootingSpeedConstants {
    ...
    public static double launchZoneSpeed = 3700;
    ...
    public static int dynamicTolerance = 100;
    public static int ejectionRPMThreshold = 0;

    //old PIDF values yigal said to save
    //public static double p = 0.006 ,i = 0 ,d = 0, f = 0.00025;
    public static double p = 0.006, i = 0, d = 0, fs = 0.1, fv = 0.00025;
}
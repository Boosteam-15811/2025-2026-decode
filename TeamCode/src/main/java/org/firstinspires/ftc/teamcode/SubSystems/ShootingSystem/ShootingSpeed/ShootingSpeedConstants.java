...
public class ShootingSpeedConstants {
    public static double launchZoneSpeed = 3770;
    public static double atGoalSpeed = 2300;
    public static double farFromGoalSpeed = 3000;
    public static double disabledSpeed = 0;

    public static int farFromGoalTolerance = 50;
    public static int launchZoneTolerance = 50;
    public static int atGoalTolerance = 50;

    public static int dynamicTolerance = 50;
